...
GITHUB_REPOS_PER_PAGE = int(os.getenv("GITHUB_REPOS_PER_PAGE", "100"))
GITHUB_REPOS_TYPE = os.getenv("GITHUB_REPOS_TYPE", "owner")
GITHUB_REPOS_SORT = os.getenv("GITHUB_REPOS_SORT", "updated")
...
PINECONE_QUERY_TOP_K = 3
PINECONE_QUERY_TOP_N = 3
PINECONE_INDEX_TIMEOUT = 90
PINECONE_NAMESPACE_CACHE_TTL = int(os.getenv("PINECONE_NAMESPACE_CACHE_TTL", "300"))
